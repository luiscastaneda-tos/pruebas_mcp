...
2. **Rol Asignado** (`Backend Dev Agent` o `Test & QA Agent`)
3. **Objetivo y Contexto**
4. **Criterios de Aceptación (Definition of Done)**
5. **Paso a Paso de Implementación**
6. **Validación de Pruebas (Test Plan)**
7. **Checklist de Verificación del Orquestador**

---

## 🗂️ Índice de Tareas Planificadas

* [TASK-001: Setup del Proyecto & Entorno Vercel](./TASK-001-setup.md)
